...
public class MeshGenerator : MonoBehaviour
{
    ...
    // tskes in a 2D array of intigers for map and square size
    ...
    public class SquareGrid
    {
        ...
        // takes in 2D array of images from map/ what size the squares will be displayed as
        public SquareGrid(int[,] map, float squareSize)
        {
            ...
            for (int x = 0; x < nodeCountX; x++)
            {
                ...
                {
                    // Culculate position of current control node
            ...
            // go through each square in array and set each each on equal to a new square
    ...
    public class Square
    {
        // refrence all four control nodes
        public ControlNode topLeft, topRight, bottomRight, bottomLeft;
        public Node centerTop, centerRight, centerBottom, centerLeft;
        public int configuration;

        // takes all control nodes
    ...
    public class Node
    {
        // kepp track of position in world
    ...
    {
        // If active (Wall) If not active (Not Wall)
        public bool active;
